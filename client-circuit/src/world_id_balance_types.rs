...
pub struct WorldIdBalanceClaimNative {
...
pub struct WorldIdBalanceNativeInput {
    ...
    pub claims: Vec<WorldIdBalanceClaimNative>,
...
impl WorldIdBalanceInput<Fr> {
    pub fn new(
        ...
        num_proofs: usize,
        max_proofs: usize,
        claims: Vec<WorldIdBalanceClaimNative>,
        block_number: u64,
        message_hash: H256,
    ) -> Self {
        ...
        for _i in 0..num_proofs {
            ...
            signatures_native.push(claims[_i].signature.clone());
        }
