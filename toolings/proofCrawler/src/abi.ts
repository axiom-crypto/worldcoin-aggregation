...
export const abi = [
  {
    inputs: [
      ...
      { internalType: "contract IGrant", name: "_grant", type: "address" },
    ],
  ...
  { inputs: [], name: "InvalidReservationSigner", type: "error" },
  ...
  { inputs: [], name: "UnauthorizedSigner", type: "error" },
  {
    ...
    name: "AllowedReservationSignerAdded",
    type: "event",
  },
  {
    anonymous: false,
    ...
    name: "AllowedReservationSignerRemoved",
    type: "event",
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    name: "RecurringGrantDropInitialized",
    type: "event",
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    name: "addAllowedReservationSigner",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  },
  {
    inputs: [],
    name: "grant",
    outputs: [{ internalType: "contract IGrant", name: "", type: "address" }],
  ...
  {
    inputs: [{ internalType: "address", name: "_signer", type: "address" }],
    name: "removeAllowedReservationSigner",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  },
  {
    ...
    name: "worldIdRouter",
    outputs: [
      { internalType: "contract IWorldIDGroups", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
