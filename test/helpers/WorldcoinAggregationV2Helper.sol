...
/// `axiom_circuit/data/worldcoin_input.json` that has two receivers. So the
...
contract WorldcoinAggregationV2Helper is AxiomTest {
    ...
    function setUp() public virtual {
        ...
        querySchema = axiomVm.readRustCircuit("axiom_circuit/Cargo.toml", inputPath, "axiom_circuit/data", "run_v2_circuit");
